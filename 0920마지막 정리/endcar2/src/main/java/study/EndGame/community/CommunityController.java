...
import study.EndGame.comment.CommentDto;
import study.EndGame.comment.CommentService;
...
//    }
    ...
    public String save(@ModelAttribute CommunityDto communityDto, Model model, Authentication auth) throws IOException {
