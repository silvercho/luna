...
public class BoardController {
	...
	public String write_pro(/*
							 * @Valid @ModelAttribute("writeContentBean") ContentBean writeContentBean,
							 * BindingResult result
							 */) {
		/*
		 * if(result.hasErrors()) { return "board_write"; }
		 * 
		 * boardService.addContentInfo(writeContentBean);
		 */
		
		return "board_write_success";
	}
	...
	public String modify_pro(/*
		 ...
		 * model.addAttribute("page", page);
		 * 
		 * if(result.hasErrors()) { return "board_modify"; }
		 * 
		 * boardService.modifyContentInfo(modifyContentBean);
		 */
		
		return "board_modify_success";
	}
